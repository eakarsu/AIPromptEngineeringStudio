...
const FEATURE_SLUG = 'no-ai-piiinjection-security-scanning-ui-stub';
const FEATURE_TITLE = 'No AI PII/injection security scanning (UI stubs exist; no backend route)';
const PROJECT = 'AIPromptEngineeringStudio';
